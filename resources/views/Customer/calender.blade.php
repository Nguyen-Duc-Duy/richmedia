...
<head>
  <meta charset="UTF-8">
  <title>Trang chủ - AKC</title>
  <link rel="icon" href="{{ asset('public/Customer/img/favicon.png')}}">
  <link rel="stylesheet" href="{{ asset('')}}public/Customer/home/style/style.css">
  <script src="{{asset('')}}/public/Customer/js/fontawesome.js"></script>
...
<div class="circle" style="z-index: 1000">
  <div class="ring">
    <a href="{{ route('Gioi_thieu')}}" class="menuItem fas fa-box-open fa-2x" title="Giới thiệu"></a>
    <a href="{{ route('Bao_gia')}}" class="menuItem fas fa-money-check-alt fa-2x" title="Báo Giá"></a>
    <a href="{{ route('Tin_tuc')}}" class="menuItem far fa-newspaper fa-2x" title="Tin tức"></a>
    <a href="{{ route('Lien_he')}}" class="menuItem fas fa-id-badge fa-2x" title="Liên hệ"></a>
    <a href="{{ route('Tuyen_dung')}}" class="menuItem fas fa-users fa-2x" title="Tuyển dụng"></a>
  </div>
  <a href="#" id="nav-my" class="center fa fa-th fa-2x"></a>
</div>
...
<!-- partial -->
  <script  src="{{ asset('')}}public/Customer/home/style/script.js"></script>
<script type="text/javascript">
  var items = document.querySelectorAll('.menuItem');
    ...
    document.querySelector('#nav-my').onclick = function(e) {
